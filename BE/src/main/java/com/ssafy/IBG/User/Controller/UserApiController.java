...
public class UserApiController {
    ...
    public Result getUserInfo(@PathVariable("userNo") Integer userNo){
        ...
        UserInfoResponse response = new UserInfoResponse(user.getNo(), user.getEmail(), user.getNick());
