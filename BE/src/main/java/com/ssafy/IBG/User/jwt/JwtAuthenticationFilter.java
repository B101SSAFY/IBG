package com.ssafy.IBG.User.jwt;

import com.auth0.jwt.JWT;
import com.auth0.jwt.algorithms.Algorithm;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.ssafy.IBG.User.dto.UserResponse;
import com.ssafy.IBG.Common.config.auth.PrincipalDetails;
...
//            PrincipalDetails principalDetails = (PrincipalDetails) authentication.getPrincipal();
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain, Authentication authResult) throws IOException, ServletException {
        ...
        String jwtToken = JWT.create()
                ...
                .withClaim("userNo", principalDetails.getUser().getNo()) // 넣고 싶은 key value 값
        ...
        Result result = new Result(HttpStatus.OK.value(), new UserResponse(principalDetails.getUser().getNo(), principalDetails.getUser().getEmail()));
